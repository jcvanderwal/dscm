...
public class DisplaysTest_listAll {
    ...
    public void happyCase() throws Exception {
        ...
        // given
        final List<Display> all = Lists.newArrayList();
        
        context.checking(new Expectations() {
            {
                oneOf(mockContainer).allInstances(Display.class);
                will(returnValue(all));
            }
        });
        
        // when
        final List<Display> list = simpleObjects.allDisplays();
