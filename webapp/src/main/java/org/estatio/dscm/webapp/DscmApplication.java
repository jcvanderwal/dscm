    ...
    protected Module newIsisWicketModule() {
        ...
        final Module simpleOverrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(String.class).annotatedWith(Names.named("welcomeMessage")).toInstance("This is DSCM - The Digital Signage Content Manger of Eurocommercial Shopping Centers");
                bind(String.class).annotatedWith(Names.named("aboutMessage")).toInstance("ECP DSCM");
